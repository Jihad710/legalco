                ...
                <div className="my-20 bg-[#225559cc] p-10 rounded-lg ">
                    <div className="gap-6 grid grid-cols-2">
                        ...
                        <div className="">
                            ...
                            {
                                lawyers.slice(0,5).map(lawyer => <div key={lawyer?._id} className='flex rounded-md my-5 items-center gap-5'>
                                    <Image src={lawyer?.image} alt='Lawyer image' width={150} height={50} className='w-40 h-20 object-cover object-top rounded-lg'/>
                                    <div className="">
                                        <h3 className={`${merriweather.className} text-white text-xl`}>{lawyer?.name}</h3>
