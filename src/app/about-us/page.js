  ...
  return (
    <div>
      ...
      <div className="about-us-bg pt-[150px] -mt-[100px] text-white min-h-screen">
        ...
        <h2 className="text-xl md:text-xl mb-3 uppercase mt-4">
        About LegalCO
          </h2>
        <p className="flex items-start">
              ...
              LegalCO is a complete solution app for all your legal complexities.This platform is created to simplify legal procedures for lawyers and enrich the litigant’s journey.
              </span>
            </p>
        <p className="flex items-start">
              <span className="text-3xl font-extrabold -ml-[2px]">
              ...
              Bangladesh’s <span className="text-[#F59E0B]">No.1</span> app for online legal solutions tailored to your legal needs.
              </span>
            </p>
          <h2 className="text-xl md:text-xl mb-4 uppercase mt-4">
            Chamber Profile
          </h2>
          <div className="space-y-2 md:mb-6">
            <p className="flex items-start">
              ...
              <span className="text-[15px] ml-2">
                SEL Trident Tower, Suite # 907 (9th Floor), 57, Purana Paltan,
                (VIP Road), Dhaka - 1000.
              </span>
            </p>
...
<p className="text-[15px] mb-3 ">
  ...
  <a href="mailto:ceolegalco@gmail.com" className="bg-[#225559] hover:bg-transparent border-2 border-transparent hover:border-[#225559] text-white hover:text-white py-2 px-6 rounded-full duration-300 my-5 inline-block">
    Send Email
  </a>
</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 text-white px-8 md:px-10 lg:px-20 mt-24">
            ...
            <div className="md:mt-[5%] lg:mt-[12%]">
              ...
              <p className="flex items-start text-[17px]">
                ...
                <span>
                  Lawyers, Simplify Your Practice for an Elevated Experience
                </span>
              </p>
              <p className="flex items-start text-[17px]">
                <span className="text-2xl mr-2">&#10146;</span>
                <span>
                  Litigation Simplifying Your Effortless Journey as a Litigant
                </span>
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 text-white px-8 md:px-10 lg:px-20 mt-24">
            <div className="md:mt-[5%] lg:mt-[12%]">
              ...
              <p className="text-[17px]">
                To deliver ingenious solutions for the daily hurdles confronted
                by lawyers, law firms, and litigants
              </p>
            </div>
