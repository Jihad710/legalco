	...
	return (
		<section className="py-20 bg_imgae">
			<Container>
				...
				{/* */}
				<div className="mt-10 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
					{services?.map((service, idx) => (
						<div
							key={idx}
							className="border-2 bg-white shadow-lg p-5 flex items-center gap-5 rounded-2xl rounded-tr-none rounded-bl-none "
						>
